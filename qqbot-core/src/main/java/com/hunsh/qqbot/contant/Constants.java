...
public class Constants {
    ...
    public enum ApiURL {
        ...
        GET_PTWEBQQ_CODE("", "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1"),
        GET_VFWEBQQ_CODE("http://s.web2.qq.com/api/getvfwebqq?ptwebqq={1}&clientid=53999199&psessionid=&t=0.1", "http://s.web2.qq.com/proxy.html?v=20130916001&callback=1&id=1");
        private String url;
